...
export function RepositoryCard({
    ...
    <div className="flex items-center justify-between px-6 py-4 border-b  hover:bg-zinc-100 transition-colors">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <Badge variant={isPrivate ? "outline" : "secondary"} className="rounded-full text-xs font-normal bg-sky-100 text-sky-500">
  ...
  <span className="flex items-center gap-1">
    <svg viewBox="0 0 16 16" width="16" height="16" className="fill-current opacity-50">
