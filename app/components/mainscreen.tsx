...
import { CloudIcon as Azure, Gitlab, KeyIcon } from 'lucide-react'
...
function Mainscreen() {
  return (
    ...
    <div className="p-5 relative flex items-center justify-center bg-gradient-to-br from-blue-50 to-white min-h-screen hidden md:flex">
      <div className="max-w-md ">
        ...
        <Card className="p-6 shadow-lg border-0 bg-white rounded-3xl">
          <div className="space-y-6">
            ...
            />
            <h2 className="text-xl font-semibold text-navy-900">AI to Detect & Autofix Bad Code</h2>
            </div>
        ...
        <Card className="absolute w-[270px] h-[164px] -bottom-[8rem] -right-[1rem] p-4 shadow-lg border-0 bg-white rounded-3xl">
          <div className="flex items-start justify-between mb-3">
            ...
            <span className="text-green-600 font-medium text-sm">14%</span>
            <span className="text-xs text-muted-foreground">This week</span>
            </div>
          </div>
          <div>
            <div className="text-sm font-medium text-muted-foreground mb-1">Issues Fixed</div>
      ...
      {/* Background Logo */}
      <div className="absolute  left-0 w-60 h-60 opacity-30 -mb-[41rem] hidden md:block ">
        <Image
        src="/Subtract.png"
        alt="Ant Logo"
        fill
